...
if __name__ == "__main__":
    ...
    # print(extract_urls("file:///Users/chris/ToDelete/36263_ti09m006.pdf"))
    # print(extract_urls("mailto:office@ver-max.at"))
    # print(extract_urls("mailto:a@ver-max.at"))
    print(extract_emails("mailto:a@ver-max+x123.at"))
