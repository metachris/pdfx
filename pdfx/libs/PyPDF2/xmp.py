...
class XmpInformation(PdfObject):
    ...
    xmp_createDate = property(_getter_single(XMP_NAMESPACE, "CreateDate",
                                             _converter_date))
    """
    ...
    xmp_modifyDate = property(_getter_single(XMP_NAMESPACE, "ModifyDate",
                                             _converter_date))
    """
    ...
    xmp_metadataDate = property(_getter_single(XMP_NAMESPACE, "MetadataDate",
                                               _converter_date))
    """
